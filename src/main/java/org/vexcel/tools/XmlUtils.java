...
public class XmlUtils {
    ...
    private List<ValidateRule> getCoulumnRules(Element sheetElement) {
        ...
        for (Element e1 : (List<Element>) sheetElement.elements("column")) {
            ...
            String checkSpecChar = e1.attributeValue("checkSpecChar");
            String minLength = e1.attributeValue("minLength");
            ...
            // String scale = e1.attributeValue("scale");dateFormat
            ...
            ruleEntity
                    .setIsFilterSpecChar(isNull(checkSpecChar) ? null : (checkSpecChar.equals("true") ? true : false));
